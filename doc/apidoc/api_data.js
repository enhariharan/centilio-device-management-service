define({ "api": [
      ...
      "fields": {
        "Parameter": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "all",
            "description": "<p>/devices?all=true will return all devices in the corporate. Only admin can use this.</p>"
          },
          {
            "group": "Parameter",
            "type": "json",
            ...
            "description": "<p>/devices?unassignedOnly=true will return all devices in the corporate that are not yet assigned to any user, provided the logged in user has role admin. If false, only assigned devices will be returned.  This option must be preceded by the param all=true else it will be ignored. Only admin can use this.</p>"
          }
        ]
      }
    },
  ...
  {
    "type": "get",
    "url": "/devices/:id Get device by given uuid or deviceId. Admin can query for any device.",
    "title": "User can query for devices owned by that user.",
    "name": "getDevice",
    "group": "Device",
    "parameter": {
      "fields": {
    ...
    "sampleRequest": [
      {
        "url": "http://api.centilio.com/v1//devices/:id Get device by given uuid or deviceId. Admin can query for any device."
      }
    ]
  },
  {
