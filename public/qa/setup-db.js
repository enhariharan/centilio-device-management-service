...
var deviceParamLongitude = new DeviceParam(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   name: 'longitude',
   description: 'longitude of the device position',
   category: "Location coordinates",
   deviceType: 'all'});
var deviceParamChargingStatus = new DeviceParam(
  {uuid: utilities.getUuid(),
   ...
   description: 'charging status of the device',
   category: "Power parameters",
   deviceType: 'all'});
var deviceParamCurrentCharge = new DeviceParam(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   name: 'current charge',
   description: 'current chare status of the device',
   category: "Power parameters",
   deviceType: 'all'});
var deviceParamBrightness = new DeviceParam(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   name: 'brightness',
   description: 'brightness of the device position',
   category: "Display",
   deviceType: deviceTypeLight.uuid});
var deviceParamTemperature = new DeviceParam(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   name: 'temperature',
   description: 'temperature of the device position',
   category: "Thermal",
   deviceType: deviceTypeMobile.uuid});
...
var client1corp1 = new Client(
  {uuid: utilities.getUuid(),
   ...
   type: 'corporate',
   role: roleUser.uuid,
   primaryEmail: 'client1corp1@snigdha.co.in'});
var client2corp1 = new Client(
  {uuid: utilities.getUuid(),
   ...
   type: 'corporate',
   role: roleAdmin.uuid,
   primaryEmail: 'client2corp1@snigdha.co.in'});
var client1corp2 = new Client(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   corporateName: 'corporation 2',
   firstName: 'John',
   lastName: 'Doe',
   type: 'corporate',
   role: roleUser.uuid,
   primaryEmail: 'client1corp2@snigdha.co.in'});
var client2corp2 = new Client(
  {uuid: utilities.getUuid(),
   ...
   type: 'corporate',
   role: roleAdmin.uuid,
   primaryEmail: 'client2corp2@snigdha.co.in'});
var client1retail = new Client(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   corporateName: 'Ashok Kumar',
   firstName: 'Ashok',
   lastName: 'Kumar',
   type: 'retail',
   role: roleUser.uuid,
   primaryEmail: 'client1retail@snigdha.co.in'});
var client2retail = new Client(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   corporateName: 'Kishore Subramanian',
   firstName: 'Kishore',
   lastName: 'Subramanian',
   type: 'retail',
   role: roleUser.uuid,
   primaryEmail: 'client2retail@snigdha.co.in'});
var clientSurya = new Client(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   corporateName: 'Snigdha',
   firstName: 'Surya',
   lastName: 'Vempati',
   type: 'corporate',
   role: roleAdmin.uuid,
   primaryEmail: 'info@snigdha.co.in'});
var clientLydor = new Client(
  {uuid: utilities.getUuid(),
   ...
   type: 'corporate',
   role: roleAdmin.uuid,
   primaryEmail: 'srinivasa.reddy@lydor.in'});
var clientSaiRajesh = new Client(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   corporateName: 'SaiRajesh',
   firstName: 'Sai Krishna',
   lastName: 'Rajesh Narayanan',
   type: 'corporate',
   role: roleAdmin.uuid,
   primaryEmail: 'skotha@gmail.com'});
var clientBabu = new Client(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   corporateName: 'Singdha',
   firstName: 'Babu',
   lastName: 'Choudhary',
   type: 'corporate',
   role: roleAdmin.uuid,
   primaryEmail: 'bnbudiya785@gmail.com'});
...
var device3 = new Device(
  {uuid: utilities.getUuid(),
   ...
   name: 'device 3',
   status: 'online',
   deviceType: deviceTypeHomeAppliance.uuid,
   client: client2corp1.uuid});
var device4 = new Device(
  {uuid: utilities.getUuid(),
   ...
   status: 'online',
   deviceType: deviceTypeLight.uuid,
   client: client1retail.uuid});
var deviceSurya = new Device(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   deviceId: '865980021035123',
   name: 'Surya mobile',
   status: 'online',
   deviceType: deviceTypeMobile.uuid,
...
var deviceBabu = new Device(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   deviceId: '911506601398526',
   name: 'Babu mobile',
   status: 'online',
   deviceType: deviceTypeMobile.uuid,
   client: clientBabu.uuid});
var deviceLydor = new Device(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   deviceId: '911506601398527',
   name: 'Lydor mobile',
   status: 'online',
   deviceType: deviceTypeMobile.uuid,
   client: clientLydor.uuid});
var deviceSaiRajesh = new Device(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   deviceId: '911506601398530',
   name: 'SaiRajesh mobile',
   status: 'online',
   deviceType: deviceTypeMobile.uuid,
   client: clientSaiRajesh.uuid});
var deviceSnigdhaUnassigned = new Device(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   deviceId: '911506601398531',
   name: 'Unnassigned mobile belonging to company Snigdha',
   status: 'online',
   deviceType: deviceTypeMobile.uuid});
var devices = [device1, device2, device3, device4, deviceSurya, deviceBabu, deviceLydor, deviceSaiRajesh, deviceSnigdhaUnassigned];

var address1Client1Corp1 = new Address(
  {client:client1corp1.uuid,
   ...
   type: 'work',
   status: 'active'});
var address1Client2Corp1 = new Address(
  {client:client2corp1.uuid,
   line1:'123, HiTec City',
   line2: '',
   city: 'Hyderabad',
   ...
   type: 'work',
   status: 'active'});
var address2Client2Corp1 = new Address(
  {client:client2corp1.uuid,
   line1:'301, Pushpa apartments',
   line2: 'Saidabad',
   city: 'Hyderabad',
   state: 'Telangana',
   countryCode: 'IN',
   ...
   type: 'home',
   status: 'active'});
var address1Client1Corp2 = new Address(
  {client:client1corp2.uuid,
   ...
   type: 'work',
   status: 'active'});
var address1Client2Corp2 = new Address(
  {client:client2corp2.uuid,
   line1:'123, Example Street',
   city: 'ExampleCity',
   state: 'ExampleState',
   countryCode: 'IN',
   ...
   type: 'work',
   status: 'active'});
var address1Client1retail = new Address(
  {client:client1retail.uuid,
   line1:'123, Example Street',
   city: 'ExampleCity',
   state: 'ExampleState',
   ...
   type: 'work',
   status: 'active'});
var address2Client1retail = new Address(
  {client:client1retail.uuid,
   line1:'123, Example Street',
   city: 'ExampleCity',
   state: 'ExampleState',
   ...
   type: 'home',
   status: 'active'});
var address1Client2retail = new Address(
  {client:client2retail.uuid,
   line1:'301, Another Example Street',
   city: 'ExampleCity',
   state: 'ExampleState',
   countryCode: 'IN',
   zipCode: '510059',
   ...
   type: 'work',
   status: 'active'});
var address2Client2retail = new Address(
  {client:client2retail.uuid,
   line1:'123, Example Street',
   city: 'ExampleCity',
   state: 'ExampleState',
   ...
   type: 'home',
   status: 'active'});
var address3Client2retail = new Address(
  {client:client2retail.uuid,
   line1:'123, Example Street',
   city: 'ExampleCity',
   state: 'ExampleState',
...
var addressSurya = new Address(
  {client:clientSurya.uuid,
   line1:'102, Madhu Residency',
   line2:'Patrika Nagar',
   city: 'Hyderabad',
   state: 'Telangana',
   countryCode: 'IN',
...
var email1Client1Corp1 = new Email(
  {client:client1corp1.uuid,
   email: 'client1corp1@snigdha.co.in',
   type: 'primary'});
var email2Client1Corp1 = new Email(
  {client:client1corp1.uuid,
   email: 'client.1@corp1.com',
   type: 'work'});
var email3Client1Corp1 = new Email(
  {client:client1corp1.uuid,
   email: 'client.1@gmail.com',
   type: 'personal'});
var email1Client2Corp1 = new Email(
  {client:client2corp1.uuid,
   email: 'client2corp1@snigdha.co.in',
   type: 'primary'});
var email1Client1Corp2 = new Email(
  {client:client1corp2.uuid,
  email: 'client1corp2@snigdha.co.in',
   type: 'primary'});
var email1Client2Corp2 = new Email(
  {client:client2corp2.uuid,
   email: 'client2corp2@snigdha.co.in',
   type: 'primary'});
var email1Client1retail = new Email(
  {client:client1retail.uuid,
   email: 'client1retail@snigdha.co.in',
   type: 'primary'});
var email2Client1retail = new Email(
  {client:client1retail.uuid,
   email: 'client.1@gmail.com',
   type: 'personal'});
var email1Client2retail = new Email(
  {client:client2retail.uuid,
   email: 'client2retail@snigdha.co.in',
   type: 'primary'});
var email2Client2retail = new Email(
  {client:client2retail.uuid,
   email: 'abc.def@rediffmail.com',
   type: 'personal'});
var email1Surya = new Email(
  {client:clientSurya.uuid,
   email: 'info@snigdha.co.in',
   type: 'primary'});
var email1Lydor = new Email(
  {client:clientSurya.uuid,
   email: 'srinivasa.reddy@lydor.in',
   type: 'primary'});
var email1SaiRajesh = new Email(
  {client:clientSurya.uuid,
   email: 'skotha@gmail.com',
   type: 'primary'});
var email1Babu = new Email(
  {client:clientBabu.uuid,
   email: 'bnbudiya785@gmail.com',
   type: 'primary'});
...
var cn1Client1Corp1 = new ContactNumber(
  {client:client1corp1.uuid,
   number: '+911234567890',
   type: 'work'});
var cn1Client2Corp1 = new ContactNumber(
  {client:client2corp1.uuid,
   number: '+913456789012',
   type: 'work'});
var cn1Client1Corp2 = new ContactNumber(
  {client:client1corp2.uuid,
   number: '+912345678901',
   type: 'work'});
var cn1Client2Corp2 = new ContactNumber(
  {client:client2corp2.uuid,
   number: '+910123456789',
   type: 'work'});
var cn1Client1retail = new ContactNumber(
  {client:client1retail.uuid,
   number: '+911234567890',
   type: 'work'});
var cn1Client1retail = new ContactNumber(
...
var cn1Client1retail = new ContactNumber(
  {client:client1retail.uuid,
   number: '+911234576890',
   type: 'fax'});
var cn1Client2retail = new ContactNumber(
  {client:client2retail.uuid,
   number: '+911234567890',
   type: 'work'});
var cn2Client2retail = new ContactNumber(
  {client:client2retail.uuid,
   number: '+912134567890',
   type: 'airtel'});
var cnSurya = new ContactNumber(
  {client:clientSurya.uuid,
   number: '+919885608076',
   type: 'work'});
var cnBabu = new ContactNumber(
  {client:clientBabu.uuid,
   number: '+919494116895',
   type: 'work'});
...
var userClient2corp1 = new User(
  {uuid: utilities.getUuid(),
   ...
   client: client2corp1.uuid,
   role: roleAdmin.uuid});
var userClient1corp2 = new User(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   username: 'userClient1Corp2',
   password: 'password',
   status: 'activated',
   gender: 'female',
   profilePicPath: '//some/example/path',
   client: client1corp2.uuid,
   role: roleUser.uuid});
var userClient2corp2 = new User(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   username: 'userClient2corp2',
   password: 'password',
   status: 'activated',
   gender: 'male',
   profilePicPath: '//some/example/path',
   client: client2corp2.uuid,
   role: roleAdmin.uuid});
var userClient1retail = new User(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   username: 'userClient1retail',
   password: 'password',
   status: 'activated', gender: 'male', profilePicPath: '//some/example/path',
   client: client1retail.uuid, role: roleUser.uuid});
var userClient2retail = new User(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   username: 'userClient2retail',
   password: 'password',
   status: 'activated',
   gender: 'female',
   profilePicPath: '//some/example/path',
...
var babu = new User(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   username: 'bnbudiya785@gmail.com',
   password: 'password',
   status: 'activated',
   gender: 'male',
   profilePicPath: '//some/example/path',
...
var device1Reading1 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
   readings: [
     {type: 'latitude', value: '100.01'},
     {type: 'longitude', value: '100.001'},
     {type: 'charging status', value: 'charging'},
     {type: 'current charge', value: '80'}
   ]});
var device1Reading2 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
   readings: [
     {type: 'latitude', value: '100.001'},
     {type: 'longitude', value: '100.001'},
     {type: 'charging status', value: 'charging'},
     {type: 'current charge', value: '85'}
   ]});
var device1Reading3 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
   readings: [
     ...
     {type: 'longitude', value: '100.001'},
     {type: 'charging status', value: 'charging'},
     {type: 'current charge', value: '90'}
   ]});
var device1Reading4 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
   readings: [
     ...
     {type: 'longitude', value: '100.001'},
     {type: 'charging status', value: 'charging'},
     {type: 'current charge', value: '95'}
   ]});
var device1Reading5 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
   readings: [
     ...
     {type: 'longitude', value: '100.001'},
     {type: 'charging status', value: 'charging'},
     {type: 'current charge', value: '100'}
   ]});
var device2Reading1 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
...
var device2Reading2 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
...
var device2Reading3 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
...
var device2Reading4 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
...
var device2Reading5 = new DeviceReading(
  {uuid: utilities.getUuid(),
   timestamp: utilities.getTimestamp(),
   serverTimestamp: utilities.getTimestamp(),
   device: device1.uuid,
